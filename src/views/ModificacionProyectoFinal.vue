  ...
  <v-container>
    <v-card elevation="12">
      <v-card-title class="justify-center blue lighten-5">
        MODIFICACION DE PROYECTO FINAL
      </v-card-title>
      <v-card-text>
          ...
          <v-row>
            <v-col>
              <v-menu
                ...
                :return-value.sync="proyectoAModificar.fechaInicio"
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field
                    v-model="proyectoAModificar.fechaInicio"
                ...
                >
                  ...
                  <v-btn
                    text
                    color="success"
                    @click="$refs.menu.save(proyectoAModificar.fechaInicio)"
                    >OK</v-btn
                  >
                </v-date-picker>
              </v-menu>
            ...
            <v-col>
              <v-menu
                ...
                v-model="menu2"
                :close-on-content-click="false"
                :return-value.sync="proyectoAModificar.fechaFinal"
                transition="scale-transition"
                offset-y
                min-width="290px"
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field
                    v-model="proyectoAModificar.fechaFinal"
                ...
                >
                  ...
                  <v-btn
                    text
                    color="success"
                    @click="$refs.menu2.save(proyectoAModificar.fechaFinal)"
                    >OK</v-btn
                  >
                </v-date-picker>
              </v-menu>
          ...
          <v-row>
            <v-col>
              <v-text-field
                ...
                v-model="proyectoAModificar.carrera"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
            <v-col>
              <v-text-field
                label="Universidad*"
                v-model="proyectoAModificar.universidad"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col>
              <v-text-field
                ...
                v-model="proyectoAModificar.titulo"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
            <v-col>
              <v-text-field
                ...
                v-model="proyectoAModificar.director"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col>
              <v-text-field
                ...
                v-model="proyectoAModificar.vinculacionConProyecto.name"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
            <v-col>
              <v-select
                ...
                v-model="proyectoAModificar.fuenteDeFinanciamiento.fuente"
...
export default {
  ...
  methods: {
    ...
    async modificarTesis() {
      ...
      var requestBody = {
        fechaInicio: this.proyectoAModificar.fechaInicio,
        fechaFinal: this.proyectoAModificar.fechaFinal,
        carrera: this.proyectoAModificar.carrera,
        universidad: this.proyectoAModificar.universidad,
        ...
        fuenteDeFinanciamiento: {
          fuente: this.proyectoAModificar.fuenteDeFinanciamiento.fuente,
        },
        persona: this.model,
      };
      axios
  ...
  created() {
    this.proyectoAModificar = this.$route.params;
    this.model = this.proyectoAModificar.persona;
  },
};
</script>