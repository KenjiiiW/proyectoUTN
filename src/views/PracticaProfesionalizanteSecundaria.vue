  ...
  <v-container>
    <v-card>
      <v-card-title style="background-color: #eeeeee" class="justify-center">
        <strong>PRACTICA PROFESIONALIZANTE SECUNDARIA</strong>
        <v-spacer></v-spacer>
        ...
        <v-btn
          ...
          elevation="12"
          fab
          to="AltaPracticaProfesionalizanteSecundaria"
        ...
        <v-row>
          ...
          <v-col>
            <v-card color="blue dark-4" dark>
              <v-card-title>
                CONSULTA UNA PRACTICA PROFESIONALIZANTE SECUNDARIA
                <v-btn
                  v-if="model"
                  text
                  fab
        ...
        <v-expand-transition>
          <v-card v-if="model" color="#ffffff">
            <v-card-title
              ...
              >DATOS DE PRACTICA PROFESIONALIZANTE SECUNDARIA</v-card-title
            >
            <v-row>
              <v-col>
    ...
    <v-dialog max-width="25%" v-model="dialogEliminar">
      <v-card>
        <v-card-title class="justify-center">
          ¿Seguro desea eliminar esta practica?
        </v-card-title>
        <v-card-actions>
          <v-spacer> </v-spacer>
...
export default {
  data() {
    return {
      vuetify: vuetify,
      item: [],
      modificar: "ModificacionPracticaProfesionalizante",
      search: "",
  ...
  methods: {
    ...
    async confirmarDialogEliminar() {
      ...
      await axios
        ...
        .then(alert("la practica profesionalizante fue eliminada de manera exitosa"));
    },
  },
  computed: {
    fields() {
    ...
    watch: {
      search: function(){
        ...
        axios
          .get(
            "http://localhost:8080/gestiondeformacionacademica/filter/practicaprofesionalizante?" +
