  ...
  <v-container>
    <v-card elevation="12">
      <v-card-title class="justify-center blue lighten-5">
        MODIFICACION DE PRACTICA SUPERVISADA
      </v-card-title>
      <v-card-text>
          ...
          <v-row>
            <v-col>
              <v-menu
                ...
                :return-value.sync="practicaAModificar.fechaInicio"
              ...
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field
                    v-model="practicaAModificar.fechaInicio"
                ...
                >
                  ...
                  <v-btn
                    text
                    color="success"
                    @click="$refs.menu.save(practicaAModificar.fechaInicio)"
                    >OK</v-btn
                  >
                </v-date-picker>
              </v-menu>
            ...
            <v-col>
              <v-menu
                ...
                v-model="menu2"
                :close-on-content-click="false"
                :return-value.sync="practicaAModificar.fechaFinal"
                transition="scale-transition"
                offset-y
                min-width="290px"
              >
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field
                    v-model="practicaAModificar.fechaFinal"
                ...
                >
                  ...
                  <v-btn
                    text
                    color="success"
                    @click="$refs.menu2.save(practicaAModificar.fechaFinal)"
                    >OK</v-btn
                  >
                </v-date-picker>
              </v-menu>
          ...
          <v-row>
            <v-col>
              <v-text-field
                ...
                v-model="practicaAModificar.carrera"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
            <v-col>
              <v-text-field
                label="Universidad*"
                v-model="practicaAModificar.universidad"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col>
              <v-text-field
                ...
                v-model="practicaAModificar.titulo"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
            <v-col>
              <v-text-field
                ...
                v-model="practicaAModificar.director"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
          </v-row>
          ...
          <v-row>
            <v-col>
              <v-text-field
                ...
                v-model="practicaAModificar.vinculacionConProyecto.name"
                :rules="reglaCampoVacio"
              ></v-text-field>
            </v-col>
            <v-col>
              <v-select
                ...
                v-model="practicaAModificar.fuenteDeFinanciamiento.fuente"
...
export default {
  ...
  methods: {
    ...
    async modificarTesis() {
      ...
      var requestBody = {
        fechaInicio: this.practicaAModificar.fechaInicio,
        fechaFinal: this.practicaAModificar.fechaFinal,
        carrera: this.practicaAModificar.carrera,
        universidad: this.practicaAModificar.universidad,
        ...
        fuenteDeFinanciamiento: {
          fuente: this.practicaAModificar.fuenteDeFinanciamiento.fuente,
        },
        persona: this.model,
      };
      axios
  ...
  created() {
    this.practicaAModificar = this.$route.params;
    this.model = this.practicaAModificar.persona;
  },
};
</script>