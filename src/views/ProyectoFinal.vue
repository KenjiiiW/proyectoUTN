        ...
        <v-expand-transition>
          <v-card v-if="model" color="#ffffff">
            <v-card-title
              ...
              >DATOS DEL PROYECTO</v-card-title
            >
            <v-row>
              <v-col>
...
export default {
  data() {
    return {
      vuetify: vuetify,
      item: [],
      modificar: "ModificacionProyectoFinal",
      search: "",
  ...
  methods: {
    ...
    async confirmarDialogEliminar() {
      ...
      await axios
        ...
        .then(alert("el proyecto fue eliminado de manera exitosa"));
    },
  },
  computed: {
    fields() {
