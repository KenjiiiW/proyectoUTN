  ...
  <v-container>
    <v-card>
      <v-card-title style="background-color: #eeeeee" class="justify-center">
        <strong>PRACTICA SUPERVISADA DE INGENIERIA</strong>
        <v-spacer></v-spacer>
        ...
        <v-btn
          ...
          elevation="12"
          fab
          to="AltaPracticaSupervisadaIngenieria"
        ...
        <v-row>
          ...
          <v-col>
            <v-card color="blue dark-4" dark>
              <v-card-title>
                CONSULTA UNA PRACTICA SUPERVISADA
                <v-btn
                  v-if="model"
                  text
                  fab
        ...
        <v-expand-transition>
          <v-card v-if="model" color="#ffffff">
            <v-card-title
              ...
              >DATOS DE PRACTICA SUPERVISADA</v-card-title
            >
            <v-row>
              <v-col>
    ...
    <v-dialog max-width="25%" v-model="dialogEliminar">
      <v-card>
        <v-card-title class="justify-center">
          ¿Seguro desea eliminar este proyecto final?
        </v-card-title>
        <v-card-actions>
          <v-spacer> </v-spacer>
...
export default {
  data() {
    return {
      vuetify: vuetify,
      item: [],
      modificar: "ModificacionPracticaSupervisada",
      search: "",
  ...
  methods: {
    ...
    async confirmarDialogEliminar() {
      ...
      await axios
        ...
        .then(alert("la practica supervisada fue eliminada de manera exitosa"));
    },
  },
  computed: {
    fields() {
